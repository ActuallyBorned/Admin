...
const yourID = "567780788880539648"; //Instructions on how to get this: https://redd.it/40zgse
...
const roles = ["DD"];
const reactions = [":free:"];
const embed = true; // Set to "true" if you want all roles to be in a single embed
const embedColor = "#dd2423"; // Set the embed color if the "embed" variable is set to true
const botToken = "NTY3NzgwNzg4ODgwNTM5NjQ4.XLYoBw.Q8mWc4kyP9Itr7S2CAsKU-bZrus";
/**
